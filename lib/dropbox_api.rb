...
require 'dropbox_api/metadata/user_membership_info'
...
require 'dropbox_api/results/sharing_list_folders_result'
...
require 'dropbox_api/endpoints/sharing/list_folders'
require 'dropbox_api/endpoints/sharing/list_folders_continue'
